# Securing a FastAPI App with OIDC
...
- explain the role of securing a fastapi app with oidc in production AI delivery
...
This chapter explains how securing a fastapi app with oidc fits into that wider delivery system.
