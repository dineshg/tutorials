# End-User Identity vs Workload Identity
...
- explain the role of end-user identity vs workload identity in production AI delivery
...
This chapter explains how end-user identity vs workload identity fits into that wider delivery system.
