# Linear Regression: The First Useful Model
...
- explain the role of linear regression: the first useful model in production AI delivery
...
This chapter explains how linear regression: the first useful model fits into that wider delivery system.
