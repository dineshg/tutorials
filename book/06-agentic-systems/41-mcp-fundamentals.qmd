...
This chapter describes Model Context Protocol (MCP) concepts using the public specification pages referenced in Further Reading. MCP changes quickly; check the official specification before implementing production systems.
:::
...
- explain the role of mcp fundamentals in production AI delivery
...
This chapter explains how mcp fundamentals fits into that wider delivery system.
...
![MCP flow showing host, client, server, external system, and audit logs.](../assets/generated/agents/mcp-client-server-flow.svg)
