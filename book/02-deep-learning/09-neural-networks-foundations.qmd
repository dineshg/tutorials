...
- explain the role of from logistic regression to neural networks in production AI delivery
...
This chapter explains how from logistic regression to neural networks fits into that wider delivery system.
