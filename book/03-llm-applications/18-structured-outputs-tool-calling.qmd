...
- explain the role of structured outputs and tool calling in production AI delivery
...
This chapter explains how structured outputs and tool calling fits into that wider delivery system.
